			...
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<p>
							<a
								href="${pageContext.request.contextPath}/doctor/patientMgmt/editPat/${patBean.id}"
								class="btn btn-primary" role="button">Edit</a>

							<a
								href="${pageContext.request.contextPath}/doctor/patientMgmt/deletePat/${patBean.id}"
