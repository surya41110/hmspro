...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
     <a class="navbar-brand" href="#">Permissions List</a>
    </div>
</div>
...
<form class="navbar-form navbar-left" role="search" action="./searchAllHosp">
  ...
  <a href="${pageContext.request.contextPath}/superAdmin/permMgmt/addPermDefn" class="btn btn-default">Add Permission</a>
