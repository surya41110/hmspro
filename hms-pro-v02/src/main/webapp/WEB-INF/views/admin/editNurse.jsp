...
<body>
	...
	<section class="container">
		<form:form method="post" action="${pageContext.request.contextPath}/admin/nurseMgmt/updateNurse"   modelAttribute="nurBean" class="form-horizontal">
			<fieldset>
				<legend>Update Nurse</legend>
